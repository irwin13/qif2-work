...
ALTER TABLE QIF_ACTIVITY_LOG_INPUT_MSG ADD MSG_TYPE VARCHAR2(255);
ALTER TABLE QIF_ACTIVITY_LOG_OUTPUT_MSG ADD MSG_TYPE VARCHAR2(255);
ALTER TABLE QIF_EVENT_LOG_MSG ADD MSG_TYPE VARCHAR2(255);