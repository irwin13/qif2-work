...
public abstract class QifProcess implements QifActivity {
    ...
    @Inject
    protected ExecutorServiceProvider threadPoolProvider;
        ...
        if (auditTrailEnabled) {
            ...
            if (keepMessageContent) {
                if (qifActivityMessage != null && qifActivityMessage.getMessageContent() != null) {
                    ...
                    inputMsg.setInputMessageContent(QifUtil.convertObjectContentToString(
    ...
    private QifEventLog insertEventLog(QifEvent qifEvent, Object eventMessage, QifMessageType messageType) {
        ...
        if (qifEvent.getAuditTrailEnabled() != null && qifEvent.getAuditTrailEnabled()) {
            ...
            if (qifEvent.getKeepMessageContent() != null && qifEvent.getKeepMessageContent()
                ...
                logContent.setMessageContent(QifUtil.convertObjectContentToString(eventMessage, messageType, jsonPrettyPrint.getObjectMapper()));
    ...
    protected QifActivityResult executeTaskWithFuture(Class<? extends QifTask> taskClass,
