 ...
 */
public class QifJsonParser {

    private static final Logger LOGGER = LoggerFactory.getLogger(QifJsonParser.class);

    private final ObjectMapper objectMapper;

    @Inject
    public QifJsonParser(ObjectMapper objectMapper) {
